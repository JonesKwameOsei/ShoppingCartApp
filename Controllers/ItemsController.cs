...
public class ItemsController : Controller
{
    ...
    // GET: Items/Create or Items/Create?ProductId/5
    public async Task<IActionResult> Create(int? productId)
    {
        ViewData["ProductId"] = new SelectList(_context.Products, "Id", "ProductName");

        var item = new Item { Price = 0, Quantity = 1 };

        // If a productId is provided, pre-fill the item details
    ...
    public async Task<IActionResult> Create([Bind("Id,Name,Quantity,Price,ProductId")] Item item)
    {
        ...
        // Re-display form with errors if and error occurred
